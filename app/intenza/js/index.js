...
$(function() {
    let chartdata = {
        ...
        datasets: [{
            ...
            hoverBackgroundColor: '#ec4343',
            hoverBorderColor: 'rgba(200,200,200,1)',
            animationEasing: "easeOutQuart",
            data: ['10', '30', '50', '60', '30', '10'],
        }]
    };
    ...
    let chartdata1 = {
        labels: ["03007", "03013", "03014", "03016", "03018", "03020","03021","03023","03024","03025"],
        datasets: [{
            label: '男',
            backgroundColor: 'blue',
            borderColor: 'rgba(200,200,200,0.75)',
            hoverBackgroundColor: '#6446fb',
            hoverBorderColor: 'rgba(200,200,200,1)',
            animationEasing: "easeOutQuart",
            data: ['90', '70', '80', '10', '30', '50','80','10','80','70'],
        },
        {
            label: '女',
            backgroundColor: 'red',
            ...
            hoverBorderColor: 'rgba(200,200,200,1)',
            animationEasing: "easeOutQuart",
            data: ['10', '30', '20', '90', '70', '50','20','90','20','30'],
        }]
    };
    let canvas1 = document.getElementById("mycanvas1");
    let ctx1 = canvas1.getContext("2d");
    let myNewChart1 = new Chart(ctx1, {
        type: 'bar',
        data: chartdata1,
        options: {
            scales: {
...
//                                                 '/' + getDate + '</th>' + '<th>' + data.data.rows[i].Miles + ' <span class="font">mile</span> ' + '</th>' + '<th>' +
//                                                 data.data.rows[i].Cal + ' <span class="font">kcal</span> ' + '</th>' + '<th>' + data.data.rows[i].Watt + ' <span class="font">w</span> ' + '</th>' + '</tr>'
//                                             );
//                                             //把當月的總資料丟到一個array裡
...
//                                                     '<tr>' + '<td>' + '<span class="font">DIS</span>' + '</td>' + '<td>' + getdEncodingArr[i].Miles + ' <span class="font">km</span>' + '</td>' + '</tr>' +
//                                                     '<tr>' + '<td>' + '<span class="font">TIME</span>' + '</td>' + '<td>' + getdEncodingArr[i].SportsTime + '</td>' + '</tr>' +
//                                                     '<tr>' + '<td>' + '<span class="font">CALORIES</span>' + '</td>' + '<td>' + getdEncodingArr[i].Cal + ' <span class="font">kcal</span>' + '</td>' + '</tr>'
//                                                 );
...
//                                                     '<tr>' + '<td>' + getdEncodingArr[i].Watt + '</td>' + '<th>' + '<span class="font">WATT</span>' + '</th>' + '<td>' + getdEncodingArr[i].MaxWatt + '</td>' + '</tr>' +
//                                                     '<tr>' + '<td>' + getdEncodingArr[i].AR + '</td>' + '<th>' + '<span class="font">RPM</span>' + '</th>' + '<td>' + getdEncodingArr[i].MaxR + '</td>' + '</tr>' +
//                                                     '<tr>' + '<td>' + getdEncodingArr[i].AH + '</td>' + '<th>' + '<span class="font">HR</span>' + '</th>' + '<td>' + getdEncodingArr[i].MaxH + '</td>' + '</tr>'
//                                                 );
//                                             });
//                                         }
